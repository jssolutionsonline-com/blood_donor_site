...
<head>
    ...
    <title>Blood Bank and Blood type Search | Become A Donor</title>
...
<?php include('includes/header.php');?>
    ...
    <div class="container">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Become a Donor<h1>Ensure you input your correct details</h1></li>
        </ol>
